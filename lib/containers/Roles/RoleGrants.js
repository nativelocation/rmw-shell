...
var RoleGrants = exports.RoleGrants = function (_Component) {
  ...
  RoleGrants.prototype.render = function render() {
    ...
    var list = _materialUiFilter.filterSelectors.getFilteredList('role_grants', filters, grantList, function (fieldValue) {
    ...
    return _react2.default.createElement(
      ...
      _react2.default.createElement(_materialUiFilter.FilterDrawer, { name: 'role_grants', fields: filterFields, formatMessage: intl.formatMessage })
    );
  };
...
var mapStateToProps = function mapStateToProps(state, ownProps) {
  ...
  return {
    ...
    uid: uid,
    intl: intl,
    user_grants: (0, _firekit.getList)(state, 'role_grants')
  };
};

exports.default = (0, _reactRedux.connect)(mapStateToProps, _extends({ setSimpleValue: _actions.setSimpleValue }, _materialUiFilter.filterActions))((0, _reactIntl.injectIntl)((0, _reactRouterDom.withRouter)((0, _firekitProvider.withFirebase)((0, _AppConfigProvider.withAppConfigs)((0, _styles.withTheme)(RoleGrants))))));