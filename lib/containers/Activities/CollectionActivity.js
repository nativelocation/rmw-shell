...
var mapStateToProps = function mapStateToProps(state, ownProps) {
  ...
  var list = _materialUiFilter.filterSelectors.getFilteredList(key, filters, (0, _firekit.getCol)(state, key), function (fieldValue) {
...
exports.default = (0, _redux.compose)((0, _reactRedux.connect)(mapStateToProps, _extends({}, _materialUiFilter.filterActions)), _reactIntl.injectIntl, _firekitProvider.withFirebase, _reactRouterDom.withRouter)(CollectionActivity);
